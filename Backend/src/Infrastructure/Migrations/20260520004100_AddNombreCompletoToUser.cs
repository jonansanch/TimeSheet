        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Turno = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    ...
                    Modalidad = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    EsRetroactivo = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SolicitudesExcepcion", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Proyectos_ClienteId_Nombre",
                table: "Proyectos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesExcepcion_UserId_FechaRegistro",
                table: "SolicitudesExcepcion",
                columns: new[] { "UserId", "FechaRegistro" });
        }
