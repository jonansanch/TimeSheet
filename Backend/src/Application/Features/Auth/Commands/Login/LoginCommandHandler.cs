...
public class LoginCommandHandler : IRequestHandler<LoginCommand, LoginResponseDto>
{
    ...
    public async Task<LoginResponseDto> Handle(LoginCommand request, CancellationToken cancellationToken)
    {
        ...
        var accessToken = _jwtTokenService.GenerateAccessToken(credentials.UserId, credentials.Email, credentials.Roles, credentials.NombreCompleto, credentials.SupervisorNombre, credentials.PuestoNombre);
